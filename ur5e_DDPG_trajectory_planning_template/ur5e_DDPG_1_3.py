...
folderpath = "./ur5e_DDPG_trajectory_planning_20000csv/"   # 保存表格文件的路径
foldername1 = 'end_motion_path_csv'   # 末端轨迹数据
foldername2 = 'joint_path_csv'   # 关节角度数据
foldername3 = 'reward_episode_csv'   # 奖励数据
